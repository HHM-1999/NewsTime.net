                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <ul class="social-network social-circle">
                                                <li><a href="https://www.facebook.com/newstime.netbd/" target="_blank"><i class="fa-brands fa-facebook-f"></i>
                                                    <span>Facebook</span>
                                                </a></li>
                                        ...
                                        <div class="col-lg-6">
                                            <ul class="social-network social-circle">
                                                <li><a href="https://www.youtube.com/@newstimedotnet" target="_blank"><i
                                                    class="fa-brands fa-youtube"></i><span>Youtube</span></a>
                                                </li>
                                                <li><a href="https://www.instagram.com/newstime.netbd/" target="_blank"><i
